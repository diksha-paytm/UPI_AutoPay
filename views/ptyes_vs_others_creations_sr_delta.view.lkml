view: ptyes_vs_others_creations_sr_delta {
  derived_table: {
    sql: WITH base_sr AS (
  ...
  dimension: d1_ptyes__ptsbi {
    type: string
    label: "D-1 (ptyes - ptsbi)"
    sql: ${TABLE}."D-1 (ptyes - ptsbi)" ;;
  }
  ...
  dimension: d2_ptyes__ptsbi {
    type: string
    label: "D-2 (ptyes - ptsbi)"
    sql: ${TABLE}."D-2 (ptyes - ptsbi)" ;;
  }
  ...
  dimension: d3_ptyes__ptsbi {
    type: string
    label: "D-3 (ptyes - ptsbi)"
    sql: ${TABLE}."D-3 (ptyes - ptsbi)" ;;
  }
  ...
  dimension: last_7_days_ptyes__ptsbi {
    type: string
    label: "Last 7 Days (ptyes - ptsbi)"
    sql: ${TABLE}."Last 7 Days (ptyes - ptsbi)" ;;
  }

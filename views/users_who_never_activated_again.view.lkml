view: users_who_never_activated_again {
  derived_table: {
    sql: WITH active_mandates AS (select *
      ...
      SELECT
      COALESCE(SUM(active_mandates.users_who_never_activated_again), 0) AS "active_mandates.users_who_never_activated_again"
  ...
  dimension: active_mandates_users_who_never_activated_again {
    type: number
    sql: ${TABLE}."active_mandates.users_who_never_activated_again" ;;
  }

  set: detail {
    fields: [active_mandates_users_who_never_activated_again]
  }
}
